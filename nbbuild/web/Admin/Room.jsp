...
<%@ include file ="Aside.jsp" %>
	<section class="section">
		<div class="sectiondev">
			<div class="container">
				<h2 style='color: #fff;'>Oda Ekle</h2>
						...
						<div class="row">
							<div class="col-sm-4">
			    				...
			    				try {
			    					...
			    					Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism?useUnicode=true&useLegacyDatetimeCode=false&serverTimezone=Turkey","root","root");
			    				...
			    				<div class="form-group">
			    					<select id="roomType" class="form-control">
			    						<option value="AC">Deniz Manzarali</option>
			    						<option value="Non-AC">Balkonlu</option>
			    					</select>
			    				</div>
			    				<div class="form-group">
			    				Oda boyutu sec:
