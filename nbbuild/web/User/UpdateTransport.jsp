					...
					<div class="row">
						<div class="col-sm-12">
							<form>
								<div class="col-sm-12">
									<div class="col-sm-4">
										<div class="form-group">Paket Adi:</div>
									</div>
									<div class="col-sm-4">
								...
								<div class="col-sm-12">
									<div class="col-sm-4">
										<div class="form-group">Ulasim Turu:</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
											<input class="form-control"
								...
								<div class="col-sm-12">
									<div class="col-sm-4">
										<div class="form-group">Arac Turunu Seciniz:</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
											<input class="form-control"
								...
								<div class="col-sm-12">
									<div class="col-sm-4">
										<div class="form-group">Arac Adi Giriniz:</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
											<input class="form-control"
								...
								<div class="col-sm-12">
									<div class="col-sm-4">
										<div class="form-group">Fiyat:</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
											<input class="form-control"
								...
								<div class="col-sm-12">
									<div class="col-sm-4">
										<div class="form-group">Tarih:</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
											<input class="form-control"
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="text-right">
												<input type="button" id="button" value="Ulasimi Degistir"
